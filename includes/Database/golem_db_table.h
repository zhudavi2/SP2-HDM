...
namespace DB
{
   ...
   **/
   class GTable : public Hector::GSerializable
   {
   public:
      GTable() {}
      ~GTable();
      ...
      */
      ...
      //! Transforms the table into a data bufer for network transmission.
      bool Serialize(GIBuffer &) const;

      //! Fills the table from a buffer after network transmission
