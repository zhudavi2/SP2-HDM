...
{
   /*!
   * Handles Politic events on Client side
   **/
   ...
   public:
      ...
      bool HandleConstitutionalFormInfoRequest(SDK::GGameEventSPtr in_pEvent);
      bool HandleInternalLawsUpdate(SDK::GGameEventSPtr in_pEvent);
		bool HandleTreatyRefusalDetails(SDK::GGameEventSPtr in_pEvent);
