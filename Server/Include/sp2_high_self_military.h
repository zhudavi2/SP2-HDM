#ifndef _EHE_OBJECTIVES_HIGH_SELF_MILITARY
#define _EHE_OBJECTIVES_HIGH_SELF_MILITARY
...
class GHighSelfMilitary : public GObjective
{
   // object must be cloneable (deep copy) for registration in the manager
   GHighSelfMilitary* Clone() const;
